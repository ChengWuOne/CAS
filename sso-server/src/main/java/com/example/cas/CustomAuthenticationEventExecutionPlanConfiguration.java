...
/**
 * This is {@link CustomAuthenticationEventExecutionPlanConfiguration}.
 *
...
public class CustomAuthenticationEventExecutionPlanConfiguration {
    ...
    public Collection<AuthenticationHandler> jdbcAuthenticationHandlers() {
       ...
       // jdbc.getQuery().forEach(b -> handlers.add(queryDatabaseAuthenticationHandler(b)));
        ...
        jdbc.getQuery().forEach(b -> handlers.add(customAuthenticationHandler(b)));
        return handlers;
    }
    ...
    private AuthenticationHandler queryAndEncodeDatabaseAuthenticationHandler(final JdbcAuthenticationProperties.Encode b) {
	 ...
	 private AuthenticationHandler customAuthenticationHandler(final JdbcAuthenticationProperties.Query b) {
	        ...
	        final MyAuthenticationHandler h = new MyAuthenticationHandler(b.getName(), servicesManager,
