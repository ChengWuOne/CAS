...
import com.example.cas.MyAuthenticationExceptionHandlerAction;
...
public class CasCoreAuthenticationSupportConfiguration {
    ...
    public Action authenticationExceptionHandler() {
        final MyAuthenticationExceptionHandlerAction h = new MyAuthenticationExceptionHandlerAction();
